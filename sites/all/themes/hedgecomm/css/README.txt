...
To use these stylesheets, rename the files and hedgecomm with the name of your theme.
...
hedgecomm-alpha-default-narrow.css  
...
hedgecomm-alpha-default-normal.css
...
hedgecomm-alpha-default-wide.css
